...
function Movie(name, genre, rating) {
  ...
  Movie.prototype.changeRating = (newRating) => this.rating += newRating / 2
...
this.savedPosts.splice(this.savedPosts.indexOf(id),1)
}
////////// PROBLEM 7 //////////
...
let updated = this.savedPosts[this.savedPosts.findIndex(post => post.id === id)]
